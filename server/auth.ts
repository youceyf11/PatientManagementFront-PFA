...
export function setupAuth(app: Express) {
  const sessionSettings: session.SessionOptions = {
    secret: process.env.SESSION_SECRET || 'medimanagesecret',
    resave: false,
  ...
  app.get("/api/admin/dashboard", checkRole(['admin']), async (req, res) => {
    try {
      ...
      const appointments = await storage.getAppointmentsByDate(todayStart);
